...
global.Owner = {
  ...
  '6288990007937': { // put your number here
  ...
  '6282141404209': { // put your number here
    name: 'Dave',
    isDev: false, // if true this number will send if bot have bug and developer mode true
    isReport: true, // if true this number will send if user use command /report or /join
    isCreator: false // if true this number will send if user use command /owner or /creator
  ...
  '6288990007937': {} // ignore if you don't want anything, like name dll
}
global.mods = ['6288990007937'] // Want some help?
global.prems = ['6288990007937'] // Premium user has unlimited limit
